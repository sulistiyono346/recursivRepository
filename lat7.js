...
function countDistanceLetterRecursive(sentences, letter) {
var count=0
if   (sentences[0]===letter[0]) {return count=count+1}
else {count=count+1}
return count + countDistanceLetterRecursive(sentences.slice(1), letter)
}
